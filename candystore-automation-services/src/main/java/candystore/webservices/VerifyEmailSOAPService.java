 ...
 * 2. Implement the WebService interface
 * 3. In the constructor, add the service object to the ATFHandler services collection
 * 4. Call your service through the ATFHandler getForecastByZIP2() as an example
 * 5. Write your test
*/
